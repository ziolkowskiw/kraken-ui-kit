...
function buttonArgTypes(
  ...
  return {
    ...
    [`${prefix}Variant`]: { control: 'select', options: BUTTON_VARIANTS, name: 'Variant', table: { category }, if: { arg: ifArg } },
    [`${prefix}Size`]: { control: 'select', options: BUTTON_SIZES, name: 'Size', table: { category }, if: { arg: ifArg } },
    [`${prefix}IconOnly`]: { control: 'boolean', name: 'iconOnly', table: { category }, if: { arg: ifArg } },
    [`${prefix}LeftIcon`]: { control: 'select', options: ICON_OPTIONS, name: 'Left icon', table: { category }, if: { arg: ifArg } },
    [`${prefix}RightIcon`]: { control: 'select', options: ICON_OPTIONS, name: 'Right icon', table: { category }, if: { arg: ifArg } },
    [`${prefix}ClosesDialog`]: { control: 'boolean', name: 'Closes dialog', table: { category }, if: { arg: ifArg } },
  }
}
        ...
        >
          <div className="flex flex-col gap-[var(--ds-spacing-component-lg)] [padding-inline:var(--ds-spacing-component-xl)] [padding-block:var(--ds-spacing-component-lg)]">
            <Alert type="informational" icon={<Info />}>
              ...
              <AlertDescription>
                Information provided by the system might not be sufficient for performing this operation.
              </AlertDescription>
            </Alert>
