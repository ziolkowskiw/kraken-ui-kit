...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A set of two-state buttons that can be toggled on or off; segmented / multi-toggle controls.",
      },
    },
  },
  tags: ["autodocs"],
  ...
  render: () => (
    <div className="flex flex-col items-center gap-4">
      ...
      <ToggleGroup skin="ghost" defaultValue={["justify"]}>
        <ToggleGroupItem value="align-left" iconOnly aria-label="Align left">
          <AlignLeft />
        </ToggleGroupItem>
        <ToggleGroupItem value="align-center" iconOnly aria-label="Align center">
          <AlignCenter />
        </ToggleGroupItem>
        <ToggleGroupItem value="align-right" iconOnly aria-label="Align right">
          <AlignRight />
        </ToggleGroupItem>
        <ToggleGroupItem value="justify" iconOnly aria-label="Justify">
          <AlignJustify />
        </ToggleGroupItem>
      </ToggleGroup>
    </div>
