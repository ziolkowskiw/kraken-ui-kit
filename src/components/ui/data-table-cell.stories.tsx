...
const meta = {
  ...
  argTypes: {
    ...
    oldValue: { control: 'text', name: 'Old value (diff)', table: { category: 'Content' } },
    secondValue: { control: 'text', name: '2nd row value', table: { category: 'Content' } },
    ...
    badgeColor: { control: 'select', options: BADGE_COLORS, name: 'Badge colour', table: { category: 'Nested: Badge' } },
    badgeLabel: { control: 'text', name: 'Badge label', table: { category: 'Nested: Badge' } },
    fileName: { control: 'text', name: 'File name', table: { category: 'Nested: File' } },
