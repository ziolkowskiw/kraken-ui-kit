...
const meta = {
  ...
  argTypes: {
    ...
    secondValue: {
      ...
      name: "2nd row value",
      table: { category: "Content" },
      if: { arg: "type", eq: "text 2 rows" },
    },
    showLeftDecoration: {
      control: "boolean",
      name: "show left decoration",
      table: { category: "Content" },
    },
    showRightDecoration: {
      control: "boolean",
      name: "show right decoration",
      table: { category: "Content" },
    },
    iconName: {
      control: "select",
...
export const AllTypes: Story = {
  render: () => (
    <div
      role="table"
      className="flex w-[280px] flex-col divide-y divide-border border border-border"
    >
      {TYPES.map((t) => (
        <div key={t} role="row" className="flex items-center">
          <span role="cell" className="w-28 shrink-0 px-2 text-xs text-muted-foreground">
            {t}
          </span>
