...
export const IconToolbar: Story = {
  render: () => (
    <div className="flex gap-4">
      <ButtonGroup>
        <Button variant="secondary" size="sm" iconOnly aria-label="Bold">
          <Bold />
        </Button>
        <Button variant="secondary" size="sm" iconOnly aria-label="Italic">
          <Italic />
        </Button>
        <Button variant="secondary" size="sm" iconOnly aria-label="Underline">
          <Underline />
        </Button>
      </ButtonGroup>
      <ButtonGroup>
        <Button variant="secondary" size="sm" iconOnly aria-label="Align left">
          <AlignLeft />
        </Button>
        <Button variant="secondary" size="sm" iconOnly aria-label="Align center">
          <AlignCenter />
        </Button>
        <Button variant="secondary" size="sm" iconOnly aria-label="Align right">
          <AlignRight />
        </Button>
      </ButtonGroup>
    </div>
