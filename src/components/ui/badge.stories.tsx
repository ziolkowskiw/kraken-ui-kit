...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "displays a badge or a component that looks like a badge; label/categorize items or show counts/status",
      },
    },
  },
  tags: ["autodocs"],
  ...
  render: ({ leftIconName, rightIconName, ...args }: StoryProps) => (
    <Badge {...args} leftIcon={renderIcon(leftIconName)} rightIcon={renderIcon(rightIconName)} />
  ),
...
export const Sizes: Story = {
  render: () => (
    <div className="flex items-center gap-2">
      <Badge color="blue" size="sm" leftIcon={<Check />}>
        sm
      </Badge>
      <Badge color="blue" size="md" leftIcon={<Check />}>
        md
      </Badge>
      <Badge color="blue" size="lg" leftIcon={<Check />}>
        lg
      </Badge>
    </div>
  ),
