...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "Fast, composable command menu; command palettes and quick search/launchers.",
      },
    },
  },
  tags: ["autodocs"],
      ...
      <CommandList>
        {(group: { value: string; items: Cmd[] }) => (
          <CommandGroup key={group.value} items={group.items}>
            ...
            <Autocomplete.Collection>{(cmd: Cmd) => renderItem(cmd)}</Autocomplete.Collection>
          </CommandGroup>
        )}
      </CommandList>
    </Command>
