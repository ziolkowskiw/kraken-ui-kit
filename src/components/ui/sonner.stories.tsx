...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "An opinionated toast component for React; transient success/error notifications.",
      },
    },
  },
  tags: ["autodocs"],
  ...
  render: () => (
    <>
      <div className="flex flex-wrap gap-2">
        ...
        <Button
          variant="secondary"
          onClick={() => toast.warning("Heads up", { description: "Your trial ends in 3 days." })}
        >
          Warning
        </Button>
        <Button
          variant="secondary"
          onClick={() =>
            toast.info("New update available", { description: "Version 2.1 is ready to install." })
          }
        >
          Info
        </Button>
