...
| form-table | [🎨 1411:*](https://www.figma.com/design/es0hWOiLEplsUrpR3EkBOK/?node-id=1411-0) | [💻](https://github.com/ziolkowskiw/kraken-ui-kit/blob/main/src/components/ui/form-table-cell.tsx) | Form-table family (`[To do]`, v1.1+). |
...
- **40 parent components mapped** (12 v1 with full prop maps + 28 others +
